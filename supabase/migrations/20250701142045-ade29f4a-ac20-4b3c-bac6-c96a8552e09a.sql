...
-- Fix the process_aggregated_order function to use correct notification type and handle null product_ids
...
BEGIN
    ...
    -- Use correct notification type that exists in the enum
